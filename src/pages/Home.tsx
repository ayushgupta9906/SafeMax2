          ...
          <div className="max-w-full">
            <div className="flex items-center justify-between w-full max-w-screen-xl mx-auto">
              ...
              <div className="relative">
                <img
                  src="https://github.com/ayushgupta9906/SafeMax2/blob/main/src/assests/sm.png"
                  alt="SafeMax Logo"
                  style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                Advanced threat detection and monitoring to stay ahead of
            ...
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                Expert guidance on implementing robust security measures and
                best practices.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Since 2020, SafeMax Security has been at the forefront of
                cybersecurity innovation, protecting businesses worldwide with
                cutting-edge VAPT services and security solutions.
              </p>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Recognized as a leading provider of cybersecurity solutions
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our team of certified security professionals brings years of
                    experience.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Quick response times and efficient problem resolution for
